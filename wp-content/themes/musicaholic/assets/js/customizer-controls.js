...
jQuery( document ).ready(function($) {
    ...
    $(".musicaholic-chosen-select").chosen({
        width: "100%"
    });
    ...
    $( document ).on( 'click', '.customize_multi_add_field', musicaholic_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', musicaholic_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', musicaholic_customize_multi_remove_field )
    ...
    function musicaholic_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            musicaholic_customize_multi_write( $control );
    }

    function musicaholic_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        musicaholic_customize_multi_write( $control );
    }

    function musicaholic_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function musicaholic_customize_multi_write( $element) {
...
( function( api ) {
    // upsell 
    api.sectionConstructor['musicaholic_upsell'] = api.Section.extend( {
