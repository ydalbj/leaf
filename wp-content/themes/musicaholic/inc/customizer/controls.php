 ...
 */
Class Musicaholic_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Musicaholic_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Musicaholic_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="musicaholic-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
class Musicaholic_Dropdown_Multiple_Chosen_Control extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="musicaholic-chosen-select" multiple="multiple" <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 * @see WP_Customize_Control
 */
Class Musicaholic_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Musicaholic_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
 ...
 * @access public
 */
class Musicaholic_Customize_Section_Upsell extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'musicaholic_upsell';
