...
class Musicaholic_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'musicaholic';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'musicaholic' ), $i ),
...
// Initialize.
$musicaholic_footer_widgets = new Musicaholic_Footer_Widgets();
