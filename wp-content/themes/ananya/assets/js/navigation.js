...
(function($){
    ...
    function initMainNavigation( container ) {
        ...
        var dropdownToggle = $( '<button />', {
            ...
            text: ananya_screenReaderText.expand
        } ) );
        ...
        container.find( '.dropdown-toggle' ).click( function( e ) {
            ...
            // jscs:enable
            screenReaderSpan.text( screenReaderSpan.text() === ananya_screenReaderText.expand ? ananya_screenReaderText.collapse : ananya_screenReaderText.expand );
        } );
    }
